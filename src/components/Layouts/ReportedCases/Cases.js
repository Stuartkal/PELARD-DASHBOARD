...
class Cases extends Component {
  ...
  async componentDidMount() {
    ...
    getAllReportedCases(userId, (response) => {
      ...
      this.setState({
        filteredCases: this.props.allCases,
        searchFilter: this.props.allCases,
      });
    });
  }
        ...
        {this.state.filteredCases.length > 0 ? (
          ...
          <div className="cases-main-form">
            ...
            <div className="message-alert">
              <p>
                Request sent successfully, email verification will be sent to
                you shortly
              </p>
            </div>
          </div>
...
const mapDispatchToProps = (dispatch) => ({
  getAllReportedCases: (_id, callback) =>
    dispatch(ActionCreators.allReportedCases(_id, callback)),
