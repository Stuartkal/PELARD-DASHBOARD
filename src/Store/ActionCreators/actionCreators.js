...
export const setLoggedInUser = (payload) => ({ type: actions.SET_LOGGEDIN_USER, payload });
...
export const setSuccessMessage = (payload) => ({ type: actions.SET_SUCCESS_MESSAGE, payload });

export const setError = (payload) => ({ type: actions.SET_ERROR, payload });

export const removeError = () => ({ type: actions.REMOVE_ERROR });

export const logIn = ({ userName, password, callback }) => ({ type: actions.LOG_IN, userName, password, callback });
...
export const setNumCases = (number) => ({ type: actions.SET_NUM_CASES, number });
...
export const getMonthly = (_id, year) => ({ type: actions.GET_MONTHLY, _id, year });

export const getDistrict = (_id) => ({ type: actions.GET_DISTRICT, _id });

export const setSingleCase = (payload) => ({ type: actions.SET_SINGLE_CASE, payload });

export const gettingCase = ({ _id, id, callback }) => ({ type: actions.GETTING_CASE, _id, id, callback });
...
export const updatingRole = (_id, role) => ({ type: actions.UPDATE_USER_ROLE, _id, role });
