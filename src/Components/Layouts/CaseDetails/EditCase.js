...
const EditCase = (props) => {
    ...
    const handleUpdate = (e) => {
        e.preventDefault()
        dispatch(ActionCreators.updatingCase(
            user._id,
            violation._id,
            state.reporterName,
                            ...
                            <div className="case-detail-row">
                                ...
                                <div className="detail">
                                    <input
                                        ...
                                        type="text"
                                        placeholder="Enter information"
                                        onChange={(e) => setState({ ...state, village: e.target.value })}
                                    />
                                </div>
                            </div>
                            <div className="case-detail-row">
                                ...
                                <div className="detail">
                                    <input
                                        ...
                                        type="text"
                                        placeholder="Enter information"
                                        onChange={(e) => setState({ ...state, districtOfViolation: e.target.value })}
                                    />
                                </div>
                            </div>
                            <div className="case-detail-row">
                                ...
                                <div className="detail">
                                    <input
                                        ...
                                        type="text"
                                        placeholder="Enter information"
                                        onChange={(e) => setState({ ...state, violationType: e.target.value })}
                                    />
                                </div>
                            </div>
                            <div className="case-detail-row">
                                ...
                                <div className="detail">
                                    <input
                                        ...
                                        type="text"
                                        placeholder="Enter information"
                                        onChange={(e) => setState({ ...state, violationDescription: e.target.value })}
                                    />
                                </div>
                            </div>
                            <div className="case-detail-row">
